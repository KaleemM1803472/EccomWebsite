        ...
        <div class="mainbody" style=" margin-top:0px;">
          ...
          <div id="createForm" >
            ...
            <form method="post" action="createAccount.php" id="RegisterForm">
              <h2 style ="padding: 40px;color: #cacaca;">Registration Info</h2>
              <div id="textboxContainers" style="align-content:center;">
                ...
                <input type="password" class="RegButtons" name ="VerifyPassword" id="Verifypassword"  placeholder=" Verify Password" required>
                <input type="email" class="RegButtons" name ="email" id="email" placeholder="yourEmail@gmail.co.uk" required>
                <input type="phonenumber" class="RegButtons" name ="phonenumber" id="phonenumber" placeholder="PhoneNumber" >
                </div>
              <input class="openbtn"  name= "Register" type="submit" id="registerLoginButton"></input>
            </form>
        </div>
          </div>
